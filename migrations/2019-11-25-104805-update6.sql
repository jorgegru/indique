CREATE TABLE IF NOT EXISTS `indique`.`commissions` ( 
...
CREATE TABLE IF NOT EXISTS `indique`.`contracts` ( `uuid` VARCHAR(45) NOT NULL , 
...
CREATE TABLE IF NOT EXISTS `indique`.`files` ( `uuid` VARCHAR(45) NOT NULL ,
